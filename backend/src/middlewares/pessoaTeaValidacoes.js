...
const validacoesDeResponsavel= [
 ...
 .withMessage("O diagnóstico deve ser um dos seguintes: Diagnóstico 1, Diagnóstico 2, Diagnóstico 3")
 .escape(),
 ...
 body("grauTEA")
    ...
    .withMessage("O grau de TEA deve ser um dos seguintes: Leve, Moderado, Grave")
    .escape(),
...
body("frequenciaUsoMedicacao")
    ...
    .isString()
    .isLength({ min: 1, max: 500 })
    .withMessage("A frequência de uso da medicação deve ter entre 1 e 500 caracteres")
    .escape(),
...
body("frequenciaUsoMedicacao")
    ...
    .withMessage("A frequência de uso da medicação não pode estar vazia")
    .isInt({ min: 0, max: 100 })
    .withMessage("A frequência de uso da medicação deve ser um valor entre 0 e 100%")
    .escape(),
...
body("frequenciaUsoMedicacao")
 ...
 body("pontuacaoProgressoInicial")
    ...
    .isInt({ min: 0, max: 100 })
    .withMessage("A pontuação do progresso inicial deve ser um valor entre 0 e 100")
    .escape(),
 ...
 body("pontuacaoProgressoAtual")
    ...
    .isInt({ min: 0, max: 100 })
    .withMessage("A pontuação do progresso atual deve ser um valor entre 0 e 100")
    .escape(),
